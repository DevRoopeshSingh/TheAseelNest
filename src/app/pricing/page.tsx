  ...
  return (
    <div className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white border border-brand-beige-dark rounded-sm p-8 md:p-12 relative overflow-hidden farm-glow mb-12 shadow-sm">
          
          {/* Dynamic Batch Availability Indicator */}
          <div className="absolute top-0 right-0 bg-brand-sand/80 backdrop-blur-md border-b border-l border-brand-beige-dark px-5 py-3 flex items-center gap-3 rounded-bl-md shadow-sm">
        ...
        <div className="bg-brand-sand border border-brand-beige-dark p-6 text-center rounded-sm mb-20 shadow-sm">
